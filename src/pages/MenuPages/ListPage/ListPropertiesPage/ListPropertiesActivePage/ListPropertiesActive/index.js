...
class ListPropertiesActive extends React.Component {
    state = {
        selectNumber: 10
    }
    handleChange = (e) => {
                ...
                <div className="card-header">
                    <div className="utils__title">
                        <div className="wrapper-title">
                            ...
                            <h5 className="page-title mr-3">Danh Sách Thuộc Tính Nguyên Liệu Đang Hoạt Động</h5>
...
export default ListPropertiesActive
